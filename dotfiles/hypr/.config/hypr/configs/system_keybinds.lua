...
local function raw_dispatch_cmd(command)
  return exec_cmd("hyprctl dispatch " .. shell_quote(command))
end
...
bind("SUPER", "E", exec_cmd("nautilus"), { description = "file manager" })
...
bind("SUPER", "V", exec_cmd("$HOME/.config/hypr/scripts/ClipManager.sh"), { description = "clipboard manager" })
...
bind("ALT_L", "SHIFT_L", exec_cmd("$HOME/.config/hypr/scripts/KeyboardLayout.sh switch"), { description = "switch keyboard layout globally", locked = true, non_consuming = true })
bind("SHIFT_L", "ALT_L", exec_cmd("$HOME/.config/hypr/scripts/Tak0-Per-Window-Switch.sh"), { description = "switch keyboard layout per-window", locked = true, non_consuming = true })
...
bind("SUPER SHIFT", "right", dispatch("movewindow", "mon:+1"))
bind("SUPER SHIFT", "left", dispatch("movewindow", "mon:-1"))
bind("SUPER SHIFT", "up", dispatch("movewindow", "mon:+1"))
bind("SUPER SHIFT", "down", dispatch("movewindow", "mon:-1"))
...
bind("SUPER", "k", dispatch("layoutmsg", "cycleprev"), { description = "cycle previous" })
...
bind("SUPER", "mouse:272", dispatch("movewindow", ""), { description = "move window", mouse = true })
bind("SUPER", "mouse:273", dispatch("resizewindow", ""), { description = "resize window", mouse = true })
